...
Use the package manager [poetry](https://python-poetry.org) to install project.
...
```bash
poetry run python client.py -u your_name
```

```bash
poetry run python client.py -u second_name
```
